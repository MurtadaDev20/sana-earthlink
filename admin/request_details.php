                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="card">
                                        <h5 class="card-header text-center">
                                            Request From
                                            <?php
                                            $query_name = mysqli_query($con, "SELECT * FROM request  where invo_id = '$request'");
                                ...
                                <?php
                                $query_statues = mysqli_query($con, "SELECT * FROM request where invo_id = '$request'");
                                $row_statues = mysqli_fetch_assoc($query_statues);
                                if (($_SESSION['rols']) == "view") {
                                    echo "";
                                }else{
                                    if ($row_statues['statues'] == 0) {
                                ?>
                                ...
                                ?>
                                    <div class="col-md-3 mt-3">
                                        <div class="card text-center">
                                            <h5>
                                                <div class="card-header">Request To The Driver</div>
                                            </h5>
