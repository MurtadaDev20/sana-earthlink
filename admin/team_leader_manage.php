                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4 class="fw-bold py-3 mb-4">
                                <span class="text-muted fw-light"> Team Leader / </span> Team Leaders Manage
                            </h4>
                                ...
                                <div class="card-datatable table-responsive pt-0">
                                    ...
                                    <table class="suber table border-top custom-table">
                                        ...
                                        <tbody class=" table-border-bottom-0">
                                            ...
                                            <?php
                                            $supervisor = mysqli_query($con, "SELECT * FROM `team_leaders` ORDER BY `id` DESC");
                                            $num = 1;
                                            while ($row = mysqli_fetch_assoc($supervisor)) {
                                                echo '
                                                            <tr>
                                                                ...
                                                                <a href="team_leader_delete.php?delete=' . $row['id'] . '" class="btn btn-danger btn-xs">حذف</a>
                                                                </td>
