                                        ...
                                        <div class="card-body">
                                            ...
                                            <form method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <select class="form-select" id="to" name="to">
                                                                <option value="0">Select a to</option>
                                                                <option>بغداد</option>
                                                                <option>البصرة</option>
                                                                <option>النجف</option>
                                                                <option>واسط</option>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" name="product_name" id="" cols="30" rows="10" required></textarea>
                                                </div>

                                                <div class="mb-3">
                                                    <label class="form-label" for="basic-default-fullname">Order Number</label>
                                                    <input class="form-control" name="order_number" type="text" placeholder="23" required>
                                                </div>
...
$query_req = mysqli_query($con , "SELECT * FROM request where invo_id = '$accept'");
$row = mysqli_fetch_array($query_req);
$req_sub_name = $row['customer_name'];
    ...
    $allowed_extensions = array('pdf', 'jpg', 'png', 'jpeg', 'pdf');
    ...
    if (in_array($file_extension, $allowed_extensions)) {
        ...
        completed_order_external (`subr_name`,`name_recipient` , `from_ex` , `to_ex` , `price` , `product_name` , `order_number` , `type_mechanism` , `file` ) 
        VALUES 
        ('$req_sub_name','$name_recipient','$from' , '$to' , '$price' , '$product_name' , '$order_number'  , '$type_mechanism' ,'$file_name')");
