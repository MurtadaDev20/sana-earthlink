                                ...
                                <div class="card-datatable table-responsive pt-0">
                                    <table class=" request-table table border-top custom-table" id="example">
                                        ...
                                        <tbody class="table-border-bottom-0">
                                            ...
                                            <?php
                                            $requests = mysqli_query($con, "SELECT * FROM invoice order by id_invo desc");
                                            //     $con,
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    ?>
                                                        <td class="bg-info text-white text-center font-weight-bold">
                                                            <?php
                                                            echo "Complete";
                                                            ?>
                                                        </td>
                                                    ...
                                                    ?>
                                                        <td class="bg-danger text-white text-center font-weight-bold">
                                                            <?php
                                                            echo "Rejected";
                                                            ?>
                                                        </td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="btn btn-info btn-xs" href="request_details.php?request=<?php echo $row['id_invo'] ?>">Details</a>
