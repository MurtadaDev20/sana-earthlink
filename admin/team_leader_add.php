...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['add_team'])) {
    ...
    $count = 0;
    $res = mysqli_query($con, "SELECT * FROM team_leaders where team_leader_name = '$fullname' or email = '$email'");
...
?>
    ...
    ?>
        ...
        $count_pass = 0;
        $query_pass = mysqli_query($con, "SELECT * FROM team_leaders where `password` = '$password'");
        ...
        <?php
            ...
            $query = mysqli_query($con, "INSERT INTO team_leaders (`team_leader_name` , `password` , `email` , `phone` , `direct_manager` , `id_hrms`  ) 
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Team Leader/</span> Team Leader Add</h4>
