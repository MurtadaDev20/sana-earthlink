            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"> /</span> حالة الطلبات</h4>
                                ...
                                <div class="card-datatable table-responsive pt-0">
                                    <table class=" request-table table border-top custom-table" id="example">
                                        ...
                                        <tbody class="table-border-bottom-0">
                                            ...
                                            <?php
                                            $requests = mysqli_query($con, "SELECT * FROM invoice where sub_id = '$_SESSION[coust_id]'  order by id_invo desc");
                                            //     $con,
