...
<script>
    $(function() {
        ...
        $("#order-form").submit(function(event) {
            ...
            if (from == "Select a from" || to == "Select a to"|| categoryId == "Select a category" || productId == "Select a product" || source == "Select a Source" ||
                                            ...
                                            <form id="order-form">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control" name="other" id="other" cols="30" rows="10" required></textarea>
                                                    </div>
                                                    ...
                                                    <label class="form-label" for="basic-default-fullname">نوع المشروع</label>
