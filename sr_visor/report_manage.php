                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        ...
                                        <div class="table-responsive text-nowrap">
                                            <table class="res table border-top custom-table" id="example">
                                                <thead>
                                                    <tr>
                                                        <th>#</th>
                                                        <th>Full Name </th>
                                                ...
                                                <tbody class="table-border-bottom-0 text-center">
                                                    <?php
                                                    $group_query = mysqli_query($con, "SELECT * FROM groups where team_id = '$_SESSION[team_id]' ORDER BY `id` DESC ");
                                                    $num = 1;
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <?php
                                                            if ($row['statues'] == 0) {
                                                                echo '<td class="text-warning ">In Prograss</td>';
                                                            } else {
