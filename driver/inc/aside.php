...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            <a href="response_manage.php" class="menu-link">
                ...
                <div data-i18n="Notifications">كل الطلبات</div><span class="bx-burst mx-4  badge badge-right rounded-pill bg-danger xs">
                    <?php
                    $req = mysqli_query($con, "SELECT COUNT(id_driv_invo) as Responce_Count FROM `invoice_driver` where id_driver = '$_SESSION[id_driver]'");
