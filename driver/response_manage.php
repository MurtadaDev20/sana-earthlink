                                ...
                                <div class="card-datatable table-responsive pt-0">
                                    <table class=" request-table table border-top custom-table" id="example">
                                        ...
                                        <tbody class="table-border-bottom-0">
                                            ...
                                            <?php
                                            $requests = mysqli_query($con, "SELECT * FROM invoice_driver where id_driver = $_SESSION[id_driver] order by id_driv_invo desc");
                                            //     $con,
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="btn btn-info btn-xs" href="request_accept.php?responce=<?php echo $row['id_driv_invo'] ?>">Details</a>
